  ...
  return (
    <div>
      <section className="cf">
        <div className={`fl w-100 w-50-m w-25-l tc pv1 ${props.sport === props.image1Description && 'ba'}`}
          onClick={e => props.setSport(props.image1Description)}>
          <div className="f6 fw4 avenir">{props.image1Description}</div>
          <img src={props.image1}/>
        </div>

        <div className={`fl w-100 w-50-m w-25-l tc pv1 ${props.sport === props.image2Description && 'ba'}`}
          onClick={e => props.setSport(props.image2Description)}>
          <div className="f6 fw4 avenir">{props.image2Description}</div>
          <img src={props.image2} />
        </div>

        <div className={`fl w-100 w-50-m w-25-l tc pv1 ${props.sport === props.image3Description && 'ba'}`}
        ...
        <div className={`fl w-100 w-50-m w-25-l tc pv1 ${props.sport === props.image4Description && 'ba'}`}
      ...
      <section className="cf">
        ...
        <div className={`fl w-100 w-50-m w-25-l tc pv1 ${props.sport === props.image5Description && 'ba'}`}
        ...
        <div className={`fl w-100 w-50-m w-25-l tc pv1 ${props.sport === props.image6Description && 'ba'}`}
        ...
        <div className={`fl w-100 w-50-m w-25-l tc pv1 ${props.sport === props.image7Description && 'ba'}`}
        ...
        <div className={`fl w-100 w-50-m w-25-l tc pv1 ${props.sport === props.image8Description && 'ba'}`}
