  ...
  return (
    <div>
      ...
      <section className="cf">
        <div className={`fl w-100 w-50-m w-25-l tc pv1 ${props.sport === props.image1Description && 'bg-light-yellow'}`}
          onClick={e => props.setSport(props.image1Description)}>
          <div className="f6 fw4 avenir">{props.image1Description}</div>
          <img src={props.image1}/>
        </div>

        <div className={`fl w-100 w-50-m w-25-l tc pv1 ${props.sport === props.image2Description && 'bg-light-yellow'}`}
          onClick={e => props.setSport(props.image2Description)}>
          <div className="f6 fw4 avenir">{props.image2Description}</div>
          <img src={props.image2} />
        </div>

        <div className={`fl w-100 w-50-m w-25-l tc pv1 ${props.sport === props.image3Description && 'bg-light-yellow'}`}
        ...
        <div className={`fl w-100 w-50-m w-25-l tc pv1 ${props.sport === props.image4Description && 'bg-light-yellow'}`}
      ...
      <section className="cf">
        ...
        <div className={`fl w-100 w-50-m w-25-l tc pv1 ${props.sport === props.image5Description && 'bg-light-yellow'}`}
        ...
        <div className={`fl w-100 w-50-m w-25-l tc pv1 ${props.sport === props.image6Description && 'bg-light-yellow'}`}
        ...
        <div className={`fl w-100 w-50-m w-25-l tc pv1 ${props.sport === props.image7Description && 'bg-light-yellow'}`}
        ...
        <div className={`fl w-100 w-50-m w-25-l tc pv1 ${props.sport === props.image8Description && 'bg-light-yellow'}`}
