...
const PlayersAndSkill = function (props) {
  return (
    ...
    <div className="cf tc">
      ...
      <dl className={`grow fl w-33 ${props.currentMinCount === 3 && 'bg-near-white'}`}
        onClick={e => props.setMinPlayers(3)}>
        <dd className="f3 fw6 ml0">3</dd>
      </dl>
      <dl className={`grow fl w-33 ${props.currentMinCount === 4 && 'bg-near-white'}`}
        onClick={e => props.setMinPlayers(4)}>
        <dd className=" f3 fw6 ml0 bl br b--black-10">4</dd>
      </dl>
      <dl className={`grow fl w-33 ${props.currentMinCount === 5 && 'bg-near-white'}`}
        onClick={e => props.setMinPlayers(5)}
        >
        <dd className=" f3 fw6 ml0">5</dd>
      </dl>

        <dl className="bg-washed-red fl w-33">
...
<div className="cf tc">
        ...
        <dl className={`grow fl w-33 ${props.currentMaxCount === 10 && 'bg-near-white'}`}
          onClick={e => props.setMaxPlayers(10)}>
          <dd className=" black-80 f3 fw6 ml0">10</dd>
        </dl>
        <dl className={`grow fl w-33 black-80 bl br b--black-10 ${props.currentMaxCount === 12 && 'bg-near-white '}`}
          onClick={e => props.setMaxPlayers(12)}>
          <dd className=" f3 fw6 ml0">12</dd>
        </dl>
        <dl className={`grow black-80 fl w-33 ${props.currentMaxCount === 18 && 'bg-near-white  b--black navy'}`}
