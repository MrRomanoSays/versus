    ...
    <div>
      ...
      />
        ...
        <div className="w-100 vh-5 tc">
            <div className={`v-mid dib inline-flex items-center ma3 br-100 ba b--black-10 h3 w3  ${props.gender === "Male" && 'bg-washed-red ba b--black '}`}
            ...
            <div className={`v-mid dib inline-flex items-center ma3  br-100 ba b--black-10 h3 w3   ${props.gender === "Female" && 'bg-washed-red ba b--black'}`}
